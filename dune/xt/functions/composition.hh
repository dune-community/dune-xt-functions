...
struct GeneralLocalfunctionChooser
{
  ...
  public:
    Localfunction(const EntityType& entity,
                  ...
                  typename Grid::EntityInlevelSearch<OuterGridViewType>& entity_search)
      : BaseType(entity)
  ...
  private:
    ...
    typename Grid::EntityInlevelSearch<OuterGridViewType>& entity_search_;
...
struct LocalfunctionForGlobalChooser
{
  ...
  public:
    Localfunction(const EntityType& entity,
                  ...
                  const typename Grid::EntityInlevelSearch<OuterGridViewType>& /*entity_search*/)
      : BaseType(entity)
...
public:
  ...
  CompositionFunction(const InnerType inner_function,
    ...
    : inner_function_(inner_function)
    , outer_function_(outer_function)
    , entity_search_(outer_grid_view)
    , name_(nm)
  {
  }
...
private:
  const InnerType inner_function_;
  const OuterType outer_function_;
  mutable typename Grid::EntityInlevelSearch<OuterGridViewType> entity_search_;
  std::string name_;
}; // class Composition
